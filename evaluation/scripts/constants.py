...
BATCH_SIZE_MEME = int(10 * MILLION)
...
IS_INDEX_TYPE_SUPPORT_MIX = INDEX_TYPES_ROBUST + INDEX_TYPES_CPU_BASELINE + [IndexType.gpu_blink_tree, IndexType.gpu_cuco_static]
...
EXP_MERGE_KEY_LENGTHS = [
    (0, 1),
    (DEFAULT_KEY_LENGTH - 1, DEFAULT_KEY_LENGTH),
    (0, DEFAULT_KEY_LENGTH),
]
