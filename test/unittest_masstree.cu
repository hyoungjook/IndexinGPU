...
typedef testing::Types<
    BTreeMapData<
        GpuBTree::
            gpu_masstree<key_type, value_type, TreeParam::BranchingFactor, bump_allocator_type>>,
    BTreeMapData<
        GpuBTree::
            gpu_masstree<key_type, value_type, TreeParam::BranchingFactor, slab_allocator_type>>>
    Implementations;
